...
export default function Header({
    ...
    return (
        <header className="flex items-center gap-2 sm:gap-3 border-b border-white/[0.06] bg-[#13131d]/60 px-3 sm:px-5 py-3 backdrop-blur z-20">
            <button
                type="button"
                className="rounded-lg p-2 hover:bg-white/10 transition-colors min-h-[44px] min-w-[44px] flex items-center justify-center"
            ...
            <div className="flex items-center gap-1 sm:gap-2">
                ...
                <div className="relative">
                    <button
                        type="button"
                        className="flex items-center gap-1 sm:gap-1.5 rounded-lg border border-white/[0.08] bg-white/[0.04] px-2 sm:px-3 py-2 text-xs text-slate-300 transition hover:bg-white/[0.08] hover:text-white min-h-[44px]"
                        onClick={() => setModelDropdownOpen((v) => !v)}
                    >
                        <span className="max-w-20 sm:max-w-32 truncate hidden sm:inline-block">
                ...
                <button
                    type="button"
                    className="rounded-lg border border-white/[0.08] px-2 sm:px-3 py-2 text-xs text-slate-300 transition hover:bg-white/[0.08] hover:text-white min-h-[44px]"
                    onClick={onLogout}
                >
